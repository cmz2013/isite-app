...
public class QuestionController extends BaseController {
     ...
     * 新增多选题目
     */
    @PostMapping(ExamUrls.URL_EXAM + "/question/choice/multiple")
     ...
     * 更新多选题目
     */
    @PutMapping(ExamUrls.URL_EXAM + "/question/choice/multiple")
     ...
     * 新增单选题和判断题
     */
    @PostMapping(ExamUrls.URL_EXAM + "/question/choice/single")
     ...
     * 更新单选题和判断题
     */
    @PutMapping(ExamUrls.URL_EXAM + "/question/choice/single")
     ...
     * 查询题目列表
     */
    @GetMapping(ExamUrls.URL_EXAM + "/question/list")
    public PageResult<Question> findQuestions(PageRequest<QuestionGetDto> request) {
        try (Page<QuestionPo> page = questionService.findPage(PageQueryConverter.toPageQuery(request, QuestionPo::new))) {
            return toPageResult(request, page.getResult().stream().map(po -> questionConverterFactory.get(
                    po.getQuestionType()).toQuestion(po)).collect(Collectors.toList()), page.getTotal());
        }
    }
     ...
     * 根据ID查询题目
     */
    @GetMapping(ExamUrls.URL_EXAM + "/question/{id}")
